...
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'application-dev.yml', 'DEFAULT_GROUP', '# swagger 配置\nswagger:\n  enabled: true\n  title: Demo Swagger API\n  gateway: http://${GATEWAY_HOST:demo-gateway}:${GATEWAY-PORT:9999}\n  token-url: ${swagger.gateway}/auth/oauth2/token\n  scope: server\n  services:\n    demo-generate: generate', 'cb97c50d10abb22385f83e1ef097c49e', '2022-05-08 12:10:37', '2022-07-01 17:28:49', 'nacos', '127.0.0.1', '', '', '', '', '', 'yaml', '', '');
