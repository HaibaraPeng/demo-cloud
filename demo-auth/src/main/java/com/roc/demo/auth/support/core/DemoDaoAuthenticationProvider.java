...
/**
 * @Description DemoDaoAuthenticationProvider
 * @Author dongp
 * @Date 2022/7/4 0004 17:33
 */
public class DemoDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public DemoDaoAuthenticationProvider() {
    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
        ...
        Map<String, DemoUserDetailsService> userDetailsServiceMap = SpringUtil.getBeansOfType(DemoUserDetailsService.class);

        String finalClientId = clientId;
        Optional<DemoUserDetailsService> optional = userDetailsServiceMap.values().stream()
